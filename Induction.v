...
Proof.
  ...
  Case "n = 0".
  rewrite -> plus_O_n. rewrite -> plus_O_n. rewrite -> plus_comm. reflexivity.
  Case "n = S n'".
  simpl. rewrite -> IHn'. reflexivity.
Qed.
(** [] *)
...
Proof.
  ...
  rewrite -> H. simpl. rewrite -> IHm'. reflexivity.
  Qed.
  (** [] *)
...
Proof.
  ...
  Case "n = 0".
    reflexivity.
  Case "n = S n'".
    assert (H: forall a, evenb a = evenb (S (S a))).
...
Proof.
  ...
  simpl. destruct c as [| c']. reflexivity. reflexivity.
  reflexivity.
Qed.
